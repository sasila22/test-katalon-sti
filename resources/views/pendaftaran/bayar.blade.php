...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('berita/create') }}" class="active"><i class="fa fa-dashboard"></i> Upload Bukti Pendaftaran</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            @endif 
            <form role="form" action="{{ url('kejuaraan/pendaftar/submitbukti') }}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group">
                  <label>Bukti Pembayaran :</label>
                  <input type="file" name="bukti" required>
                  <p class="help-block">Bisa berupa foto maupun pdf.</p>
                </div>
                <div class="form-group">
                ...
                <div>
                  <a href='{{ URL::previous() }}' class="btn btn-success btn-sm update-cart">Go Back</a>
                </div>
              </div>
            </form>
          </div>
