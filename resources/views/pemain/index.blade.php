...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('gabsi') }}" class="active"><i class="fa fa-dashboard"></i> Data Anggota Club</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Anggota Club</h3><br>
              <a class="btn btn-primary" href="{!! action('PemainController@create') !!}">TAMBAH</a>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center" >Asal Club</th>
                    <th>Aksi</th>
                    <th>Aksi</th>
                </tr>
                </thead>
                ...
                <tr>
                    ...
                    <td class="text-center"><img src="images/pemain/{{ $pemain->foto }}" style="width:100px" class="img-thumbnail"></td>
                    ...
                    <td class="text-center">{{ $pemain->id_clubs }}</td>

                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('PemainController@edit', $pemain->id) !!}">Edit</a>
                  </td>
                  <td>
                    <form action="{{ route('pemaini.destroy', $pemain->id) }}" method="POST"> 
                    {{ method_field("DELETE") }} 
                    {{ csrf_field() }}
