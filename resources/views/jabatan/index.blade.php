        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Jabatan</h3><br>
              <a class="btn btn-primary" href="{!! action('JabatanController@create') !!}">TAMBAH</a>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center" >Id Struktur</th>
                ...
                <td class="text-center">{{ $jabatan->periodes->gabsis->nama }}</td>
                <td class="text-center">{{ $jabatan->ubahTahun($jabatan->periodes->masa_bakti_awal) }} - {{ $jabatan->ubahTahun($jabatan->periodes->masa_bakti_akhir) }}</td>

                @if($jabatan->id_struktur == null)
                <td class="text-center">Belum Ada</td>
                <td class="text-center">Belum Ada</td>
                <td class="text-center">Belum Ada</td>
                @else
                <td class="text-center">{{ $jabatan->strukturs->nama }}</td>
                <td class="text-center">{{ $jabatan->jabatan }}</td>
                <td class="text-center">{{ $jabatan->divisi }}</td>
                @endif

                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('JabatanController@edit', $jabatan->id) !!}">Edit</a>
                  </td>
                  <td>
