...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('gabsi') }}" class="active"><i class="fa fa-dashboard"></i> Struktur Organisasi</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Struktur Organisasi</h3><br>
              <a class="btn btn-primary" href="{!! action('StrukturController@create') !!}">TAMBAH</a>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                @foreach ($strukturs as $key => $strukturs)
                <tr>
                    <td class="text-center">{{ $key+1 }}</td>                    
                    <td class="text-center">{{ $strukturs->nama }}</td>
                    <td class="text-center">{{ $strukturs->alamat }}</td>
                    <td class="text-center"><img src="{{ $strukturs->foto }}" style="width:100px" class="img-thumbnail"></td>

                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('StrukturController@edit', $strukturs->id) !!}">Edit</a>
                  </td>
                  <td>
                    <form action="{{ route('struktur.destroy', $strukturs->id) }}" method="POST"> 
                    {{ method_field("DELETE") }} 
                    {{ csrf_field() }}
