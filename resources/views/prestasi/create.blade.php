...
<!-- INI KONTEN -->
  ...
  <form class="form-horizontal" method="post" action="{{ url('prestasi') }} ">
    {!! csrf_field() !!}


        
    <div class="form-group">  
    <label class="control-label col-sm-2" for="id_pemain">Pemain:</label>
      <div class="col-sm-10">
        <select class="form-control" id="id_pemain" name="id_pemain">
        @foreach($pemain as $a)
        <option value="{{ $a->id }}">{{$a->nama_depan}}  {{$a->nama_belakang}}  - {{$a->id}}</option>
        @endforeach
        </select>
      </div>
    </div>     
    ...
    <table  class="table table-hover table-bordered small-text" id="tsc">
                    ...
                    <tr>              
                      ...
                      <td>
                        <input type="text"  name="pres[]" id="pres" class="form-control meja xmeja">
                      </td>
                      <td>
                        <input type="text"  name="nom[]" id="nom" class="form-control meja xmeja">
                      </td>
                      <td>
                        <input type="text"  name="ket[]" id="ket" class="form-control meja xmeja">
                      </td>
                      <td>
                        <input type="text"  name="point[]" id="point" class="form-control meja xmeja">
                      </td>
