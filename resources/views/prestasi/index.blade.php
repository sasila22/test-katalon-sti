  ...
  <aside class="main-sidebar">
    ...
    @if (Route::has('login'))
      @if (Auth::check())
        ...
        <li>
          <a href="{{ url('pemaini') }}">
            <i class="fa fa-info-circle"></i> <span>Pemain</span>
          </a>
        </li>
...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('prestasi') }}" class="active"><i class="fa fa-dashboard"></i>DATA PRESTASI</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary" href="{!! action('PrestasiController@create') !!}">TAMBAH</a>
              @if(session('status'))
      ...
      <thead>
        <tr>
          <th>No</th>
          <th>Pemain - Nama Depan</th>
          <th>Pemain - Nama Belakang</th>
          <th>Pertandingan</th>
          <th>Prestasi Medali atau Peringkat</th>
      ...
      <tr>   
        ...
        <td>{{ $p->nama }}</td>
        <td>{{ $p->prestasi_peringkat }}</td>
        <td>{{ $p->nomor_spesialis }}</td>
        <td>{{ $p->keterangan }}</td>
        <td><a href="{{ route('prestasi.edit', $p->id_prestasi)}}" class="btn btn-warning"> Ubah</a></td>
          <td>
          <form method="POST" action="{{route('prestasi.destroy', $p->id_prestasi)}}">
          {!! csrf_field() !!}
          {{method_field("DELETE")}}
