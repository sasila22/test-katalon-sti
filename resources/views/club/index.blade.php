...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('gabsi') }}" class="active"><i class="fa fa-dashboard"></i>Club</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Club</h3><br>
              <a class="btn btn-primary" href="{!! action('ClubController@create') !!}">TAMBAH</a>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center" >Asal Organisasi</th>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $c->gabsis->nama }}</td>
                    <td class="text-center">{{ $c->nama }}</td>
                    <td class="text-center">{{ $c->alamat }}</td>
                    <td class="text-center">{{ $c->no_tlp }}</td>
                    <td class="text-center">{{ $c->email }}</td>
                    <td class="text-center"><img src="{{ $c->foto }}" style="width:100px" class="img-thumbnail"></td>
                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('ClubController@edit', $c->id) !!}">Edit</a>
                  </td>
                  <td>
                    <form action="{{ route('club.destroy', $c->id) }}" method="POST"> 
                    {{ method_field("DELETE") }} 
                    {{ csrf_field() }}
