...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Info Berita Dari User
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('infor') }}" class="active"><i class="fa fa-dashboard"></i> Daftar Info Berita Dari User</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Info Berita Dari User</h3>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="{{ url('info/'.$info->doc) }}" target="_blank">{{ $info->doc }}</td>
                  <td><img src="{{ url('info/foto/'.$info->foto) }}" style="width: 150px; height: 150px;"></td>
                  <td>
                    <form action="{{ route('infor.destroy', $info->id) }}" method="POST"> 
                    {{ method_field("DELETE") }} 
                    {{ csrf_field() }}
...
<script type="text/javascript">
    $('#tampil').click(function(){
        return confirm("Anda yakin untuk menampilkan komentar ini?");
    });
    $('#ndelik').click(function(){
        return confirm("Anda yakin untuk menyembunyikan komentar ini?");
    });
</script>
