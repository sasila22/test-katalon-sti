                ...
                <tr id='tr_{{ $pendaftar->id }}'>
                  ...
                  @endif
                    <td class="actions" data-th="">
                        <a class="btn btn-danger btn-sm update-cart" data-id="{{ $pendaftar->id }}" 
                            onclick="if(confirm('apakah anda yakin ingin menghapus data?')){deleteData({{$pendaftar->id}})}">Tolak</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
...
<script type="text/javascript">
    function deleteData(id){
        $.ajax({
          type:'POST',
          url:'{{url("kejuaraan/pendaftar/hapus")}}',
          data:{'_token':'<?php echo csrf_token() ?>',
          'id':id,
        },
        success: function(data){
