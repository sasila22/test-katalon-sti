...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#" class="active"><i class="fa fa-dashboard"></i> Edit Kejuaraan</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Kejuaraan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            @endif 
            <form role="form" action="{{ route('kejuaraan.update', $kejuaraans->id) }}" method="POST" enctype="multipart/form-data">
            {{ method_field("PUT") }} 
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group">
                  <label>Nama Kejuaraan :</label>
                  <input type="text" class="form-control" name="nama" value="{{ $kejuaraans->nama }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="lokasi" value="{{ $kejuaraans->lokasi }}">
                  <p class="help-block"></p>
                </div>
                ...
                <div class="box-body pad">
                  ...
                  <form>
                    <textarea id="editor1" name="editor1" rows="10" cols="80">{{ $kejuaraans->keterangan }}</textarea>
                  </form>
                  <p class="help-block"></p>
                </div>
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Jika Tidak Ingin Merubah Formulir Pendaftaran Maka Jangan Pilih Formulir.</p>
                </div>
                
                <div class="form-group">
                  <label>Foto atau Poster Kejuaraan :</label>
                  <input type="file" name="foto">
                  <p class="help-block">Jika Tidak Ingin Merubah Foto Maka Jangan Pilih Foto.</p>
                </div>
