...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#" class="active"><i class="fa fa-dashboard"></i> Edit Tentang Gabsi</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Tentang Gabsi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" action="{{ route('tentanggabsi.update', $tentang->id) }}" method="POST" enctype="multipart/form-data">
            {{ method_field("PUT") }} 
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="box-body pad">
                  <label>Tentang Gabsi :</label>
                  <br>
                  <form>
                    <textarea id="editor1" name="editor1" rows="10" cols="80">{{ $tentang->tentanggabsi }}</textarea>
                  </form>
                  <br>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="notlp" value="{{ $tentang->notlp }}">
                  <p class="help-block"></p>
                </div>
                <div class="form-group">
                  <label>Email :</label>
                  <input class="form-control" name="email" value="{{ $tentang->email }}">
                  <p class="help-block"></p>
                </div>
                <div class="form-group">
                  <label>Alamat :</label>
                  <input class="form-control" name="alamat" value="{{ $tentang->alamat }}">
                  <p class="help-block"></p>
                </div>
