...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('galeri/create') }}" class="active"><i class="fa fa-dashboard"></i> Tambah Galeri</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            @endforeach
            <form role="form" action="{{ url('galeri') }}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group">
                  <label>Judul Foto/Video :</label>
                  <input type="text" class="form-control" name="judul" placeholder="Masukkan Judul Foto/Video Di Sini" maxlength="50" required>
                  <p class="help-block">Max karakter : 50</p>
                </div>
                <div class="form-group">
                  <label>Keterangan Foto/Video :</label>
                  <input type="text" class="form-control" name="ket" placeholder="Masukkan Keterangan Foto/Video Di Sini" maxlength="70" required>
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Pilih File Foto/Video</p>
                </div>
