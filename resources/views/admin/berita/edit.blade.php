...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#" class="active"><i class="fa fa-dashboard"></i> Edit Berita</a></li>
      </ol>
    </section>
            ...
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input class="form-control" name="judul" value="{{ $beritas->judul }}">
                  <p class="help-block"></p>
                </div>
                <div class="form-group">
                  <label>Deskripsi Singkat Berita :</label>
                  <input class="form-control" name="deskripsi" value="{{ $beritas->deskripsi }}">
                  <p class="help-block"></p>
                </div>
                ...
                <div class="box-body pad">
                  ...
                  <br>
                  <form>
                    <textarea id="editor1" name="editor1" rows="10" cols="80">{{ $beritas->isi }}</textarea>
                  </form>
                  <br>
                  <p class="help-block"></p>
                </div>
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Pilih Foto Untuk Ubah Foto Berita dan Jangan Pilih Foto Jika Tidak Ingin Ubah Foto Berita</p>
                </div>
