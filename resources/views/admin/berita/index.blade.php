...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('berita') }}" class="active"><i class="fa fa-dashboard"></i> Daftar Berita</a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="{{ url('foto/berita/'.$berita->foto) }}" style="width: 150px; height: 150px;"></td>
                  <td>
                  	<a class="btn btn-sm btn-primary" href="{!! action('BeritaController@edit', $berita->id) !!}">Edit</a>
                  </td>
                  <td>
