...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        DATA ADMIN KABUPATEN & KOTA
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('gabsi') }}" class="active"><i class="fa fa-dashboard"></i>DATA ADMIN KABUPATEN & KOTA</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">DATA ADMIN KABUPATEN & KOTA</h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $u->gabsis->nama }}</td>
                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('UserController@edit', $u->id) !!}">Edit</a>
                  </td>
                  <td>
