                ...
                <div style="overflow-x:auto;">
                  <table id="kejuaraan">
                    ...
                    <tr>
                      ...
                      <td><a href="{{ url($kejuaraan->formulir) }}" target="_blank">{{ $kejuaraan->formulir }}</td>
                      <td ><p><a href="{{'ungaleri'.$kejuaraan->link}}"><img src="{{ url('foto/galeri/'.$kejuaraan->foto) }}" style="width: 150px; height: 100px;"
                      alt="galeri-img"></a></p>
                      </td>
                    </tr>
                    @endforeach
