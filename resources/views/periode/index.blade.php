...
<!-- INI KONTEN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('periode') }}" class="active"><i class="fa fa-dashboard"></i> Daftar Periode</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Periode</h3><br>
              <a class="btn btn-primary" href="{!! action('PeriodeController@create') !!}">TAMBAH</a>
              @if(session('status'))
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center" >Masa Bakti Awal</th>
                    <th class="text-center" >Masa Bakti Akhir</th>
                    <th class="text-center" >Organisasi</th>
                    <th class="text-center" >Muskabkot</th>
                    <th class="text-center" >Tanggal Surat</th>
                    <th class="text-center" >No Surat</th>
                    <th class="text-center" >Rekom Koni</th>
                    <th>Aksi</th>
                    <th>Aksi</th>
                </tr>
                </thead>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $p->SK }}</td>
                    <td class="text-center">{{ $p->masa_bakti_awal }}</td>
                    <td class="text-center">{{ $p->masa_bakti_akhir }}</td>
                    <td class="text-center">{{ $p->namaorg }}</td>
                    <td class="text-center">{{ $p->muskabkot }}</td>
                    <td class="text-center">{{ $p->tgl_surat }}</td>
                    <td class="text-center">{{ $p->no_surat }}</td>
                    <td class="text-center">{{ $p->rekomkoni }}</td>
                  <td>
                    <a class="btn btn-sm btn-primary" href="{!! action('PeriodeController@edit', $p->id) !!}">Edit</a>
                  </td>
                  <td>
